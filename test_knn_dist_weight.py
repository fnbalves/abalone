...
for i in xrange(50):
    ...
    new_score_1 = np.mean(cross_val_score(knn_classifier_1, X_f, Y_equal_frequency, cv=10))
    new_score_2 = np.mean(cross_val_score(knn_classifier_2, X_f, Y_equal_frequency, cv=10))
