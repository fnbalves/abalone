...
for i in xrange(50):
    ...
    new_score_1 = np.mean(cross_val_score(knn_classifier_1, X_f, Y_no_transform, cv=3))
    new_score_2 = np.mean(cross_val_score(knn_classifier_2, X_f, Y_equal_size, cv=3))
    new_score_3 = np.mean(cross_val_score(knn_classifier_3, X_f, Y_equal_frequency, cv=3))
